...
module.exports = async function handler(req, res) {
  ...
  content.push({
    type: 'text',
    text: [
      `CRITICAL OUTPUT FORMAT: You are FixIt AI. You MUST respond with a single valid JSON object and NOTHING ELSE. No markdown fences. No text before the opening brace. No text after the closing brace. No trailing commas. No comments inside JSON. The VERY FIRST character of your response must be { and the VERY LAST must be }.`,
      ...
      `REMINDER — your ENTIRE response must be ONLY this JSON object, starting with { and ending with }. Do not add any text, explanation, or formatting outside these braces:`,
